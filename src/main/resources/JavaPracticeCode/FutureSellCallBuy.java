...
public class FutureSellCallBuy {
	...
	public void Calculation(int FuturePrice, int CallStrikePrice, int CallPrice, int LotSize, int Duration) {
		int PL = 0;
		int MaxPrice =0;
		int MinPrice = 0;
	...
	public static void main (String Args[]) {
		...
		new FutureSellCallBuy().Calculation(34700,34800,100,25,10);
	}
}
